            ...
            <div class="hidden md:flex md:items-center md:ms-6">
                ...
                <div class="hidden space-x-8 md:-my-px md:ms-10 md:flex me-3">
                    ...
                    <div class="flex items-center border-l border-slate-300 ml-6 pl-6 dark:border-gray-700">
                        ...
                        <button type="button" class="items-center block" x-on:click="darkMode=!darkMode">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        ...
        <div class="py-6 px-10 border-t border-gray-200 dark:border-gray-600">
            <div class="flex items-center justify-between">
                ...
                <button type="button" id="theme-toggle-mobile" x-on:click="darkMode=!darkMode" class="w-32 px-4 relative flex items-center ring-1 ring-slate-900/10 rounded-lg shadow-sm p-2 text-slate-700 font-semibold dark:bg-slate-600 dark:ring-0 dark:highlight-white/5 dark:text-slate-200">
