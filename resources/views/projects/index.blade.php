    ...
    <div class="max-w-screen-xl mx-auto px-5 mb-20">
        <div class="mt-24 text-center">
            ...
            <p class="text-lg mt-4 text-slate-500 mx-auto max-w-xl dark:text-white">
                ...
                @lang('messages.projects_description')
            </p>
        </div>
        ...
        <div class="mt-24 grid gap-8 md:grid-cols-2 lg:grid-cols-3 {{ $projects->isEmpty() ? 'hidden' : '' }}">
            ...
            <div>
                <a href="{{ route('projects.show', $project) }}">
                    <article
                        class="p-6 bg-white rounded-lg border-gray-200 shadow-md dark:bg-gray-800 hover:shadow-xl duration-300 ease-in-out border dark:hover:border-purple-700 dark:border-gray-800 @guest h-full @endguest">
                        ...
                        <div class="mb-3 mt-3 flex flex-wrap gap-2">
                            ...
                            <span class="bg-purple-100 text-purple-800 dark:bg-purple-200 dark:text-purple-800 border-purple-200 dark:border-purple-700 border  rounded-full text-xs font-medium px-3 py-1 whitespace-nowrap mb-1">
                                @if (app()->getLocale() == 'en')
                                {{ $category->name_en }}
                                @else
                                {{ $category->name }}
