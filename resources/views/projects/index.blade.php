<x-app-layout>
    <div class="max-w-screen-xl mx-auto px-5 mb-20">
        <div class="mt-16 text-center">
            <h1 class="text-4xl lg:text-5xl font-bold lg:tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-500 mb-4">
                Mis proyectos
            </h1>
            <p class="text-lg mt-4 text-slate-500 mx-auto max-w-xl dark:text-white">
                Aquí encontrarás una lista de mis proyectos más recientes. Si deseas ver más en profundidad, visita mi perfil de GitHub.
            </p>
        </div> 

        <div class="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3 {{ $projects->isEmpty() ? 'hidden' : '' }}">
                ...
                <a href="{{ route('projects.show', $project) }}">
                    <article class="p-6 bg-white rounded-lg border-gray-200 shadow-md dark:bg-gray-800 hover:shadow-xl duration-300 ease-in-out border dark:hover:border-purple-700 dark:border-gray-800">
                        <div class="flex justify-between items-center mb-5 text-gray-500">
                            <span class="text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded bg-purple-100 text-purple-800 dark:bg-purple-200 dark:text-purple-800 border-purple-200 dark:border-purple-700 border">
                        ...
                        <div class="mb-3 mt-3 flex flex-wrap gap-2">
                            @foreach ($project->categories as $category)
                                <span class="bg-purple-100 text-purple-800 dark:bg-purple-200 dark:text-purple-800 border-purple-200 dark:border-purple-700 border  rounded-full text-xs font-medium px-3 py-1 whitespace-nowrap mb-1">{{ $category->name }}</span>
                            @endforeach
                        </div>
