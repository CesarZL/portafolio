    ...
    <div class="max-w-screen-xl mx-auto px-5 mb-20">
        ...
        <div class="mx-auto max-w-3xl text-center mt-14"> 
            ...
            <div class="flex gap-2 mt-3 items-center justify-center text-sm flex-wrap md:flex-nowrap"> 
                    ...
                    <time class="text-slate-600 dark:text-slate-300" datetime="2022-08-05T15:36:00.000Z"> {{ $project->created_at->format('d/m/Y') }} </time>
        ...
        <div class="mx-auto max-w-4xl">
            <picture>
                <img src="{{ asset('storage/' . $project->image) }}" alt="Feature image" class="h-full w-full object-contain rounded-xl mt-6" data-astro-transition-scope="astro-xmqcjxod-1" width="1280" height="800" loading="lazy" decoding="async">
            </picture>
        </div>
        ...
        <div class="text-center mt-12"> 
            <a href="{{ route('projects.index') }}" class="rounded-full text-center focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-purple-500 focus-visible:outline-none focus-visible:shadow-outline-purple px-6 py-2.5 bg-white border-2 border-purple-500 hover:bg-purple-50 text-purple-600  gap-1 items-center justify-center transition duration-300 ease-out">Volver a proyectos</a>
        </div>
    </div>
</x-app-layout>